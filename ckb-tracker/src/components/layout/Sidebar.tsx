...
export function Sidebar() {
    ...
    <div className={cn(
      ...
      <div className={cn(
        ...
        {!isCollapsed && (
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-white text-lg tracking-tight">CKB Tracker</span>
          </div>
        )}
        {isCollapsed && (
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center">
        ...
        <button
          ...
          className="hidden lg:flex items-center justify-center w-8 h-8 rounded-md text-slate-400 hover:text-white hover:bg-slate-700/50 transition-colors"
        >
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-blue-500/20 text-blue-400 shadow-[inset_2px_0_0_0_#3b82f6]"
                  : "text-slate-400 hover:text-white hover:bg-slate-700/50",
                isCollapsed && "justify-center px-2"
              )}
            >
      ...
      <div className="border-t border-slate-700/50 py-4">
        {isAuthenticated && user ? (
          ...
          <Link
            href="/login"
            className="flex items-center justify-center gap-2 mx-3 py-2 rounded-lg bg-blue-500/20 text-blue-400 font-medium text-sm hover:bg-blue-500/30 transition-colors"
          >
            Sign In
          </Link>
        ) : null}
  ...
  return (
    <>
      ...
      <aside className={cn(
        "lg:hidden flex flex-col fixed left-0 top-0 h-screen w-[280px] bg-slate-900/95 backdrop-blur-sm border-r border-slate-800 transition-transform duration-300 z-50",
